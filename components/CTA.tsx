...
export function CTA() {
  return (
    <section id="contato" className="relative overflow-hidden bg-cream py-20 text-ink sm:py-28 lg:py-36">
      <div className="container-premium">
        <div className="relative overflow-hidden bg-ink">
          ...
          <div className="relative z-10 grid min-h-[600px] items-center lg:grid-cols-12">
            <motion.div
              initial={{ opacity: 0, y: 28 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.25 }}
              transition={{ duration: 0.85, ease: [0.16, 1, 0.3, 1] }}
              className="p-7 sm:p-12 lg:col-span-7 lg:p-16"
            >
              <p className="eyebrow mb-5">Vamos tirar sua ideia do papel?</p>
              <h2 className="text-balance max-w-2xl font-display text-4xl leading-[1.02] tracking-tight text-cream sm:text-5xl lg:text-6xl">
                Seu novo ambiente pode começar com uma mensagem.
              </h2>
              <p className="mt-6 max-w-xl text-sm leading-7 text-cream/65 sm:text-base">
                Conte um pouco sobre o que você imagina. A conversa inicial ajuda a entender o projeto e os próximos passos.
              </p>

              <div className="mt-8 border-l border-copper pl-5">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className={cn(buttonVariants({ variant: "primary", size: "lg" }), "mt-9 w-full sm:w-auto")}
              >
